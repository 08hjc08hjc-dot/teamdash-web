...
export const SEED_TASKS: Task[] = [
  ...
  { id: 'task-5', title: '인증 모듈 단위 테스트 작성', description: '인증 플로우 80% 커버리지 달성', status: 'in_progress', priority: 'medium', projectId: 'proj-1', assigneeIds: ['member-1', 'member-3'], dueDate: daysFromNow(7), order: 1, createdAt: daysAgo(7), updatedAt: daysAgo(2) },
  ...
  { id: 'task-10', title: '사용자 서비스 마이그레이션', description: '사용자 관리를 독립 마이크로서비스로 분리', status: 'in_progress', priority: 'high', projectId: 'proj-3', assigneeIds: ['member-5', 'member-1'], dueDate: daysFromNow(10), order: 0, createdAt: daysAgo(14), updatedAt: daysAgo(1) },
